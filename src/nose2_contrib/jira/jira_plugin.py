...
class JiraMappingPlugin(Plugin):
    ...
    def __init__(self):
        ...
        for association in self.jira_status_result_callbacks:
            self.initialize_association(JiraAndResultAssociation(association.jira_status, nose2.result.PASS))
            self.initialize_association(JiraAndResultAssociation(association.jira_status, nose2.result.FAIL))
            self.initialize_association(JiraAndResultAssociation(association.jira_status, nose2.result.ERROR))
        ...
        default_passing = JiraAndResultAssociation(self.default_jira_status, nose2.result.PASS)
        default_failing = JiraAndResultAssociation(self.default_jira_status, nose2.result.FAIL)
        default_error = JiraAndResultAssociation(self.default_jira_status, nose2.result.ERROR)
